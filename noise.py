	...
	def addNoise(self, pack):		#prymitywne zaszumienie pakietu
                if(self.typeOfChannel == 0):
                        ...
                        if(self.typeOfChannel == 1):
                                ...
                                if(self.noiseFlag == 1):
                                        if(random.randint(0, self.rangeGilbertGood) % self.probGilbertGood == 0) : #prawdopodobienstwo rozpoczecia serii bledow
                                                self.noiseFlag = 0 
                                ...
                                #istnieje duze prawdopodobienstwo ze pakiet nie zostanie zaklocony
                                        ...
                                        if(random.randint(0, self.rangeGilbertWrong) % self.probGilbertWrong == 0) : #prawdopodobienstwo rozpoczecia serii bledow
                                                self.noiseFlag = 1 
                                        return pack
                        else:
                                return pack
